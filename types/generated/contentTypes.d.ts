...
export interface ApiBookBook extends Schema.CollectionType {
  ...
  attributes: {
    ...
    genre: Attribute.Enumeration<
      ['mystery', 'fantasy', 'thriller', 'classic']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'mystery'>;
    ...
    language: Attribute.Enumeration<['english', 'hindi', 'marathi']> &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiEndUserEndUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<false>;
    processes: Attribute.Relation<
      'api::end-user.end-user',
      'manyToMany',
      'api::process.process'
    >;
    process_steps: Attribute.Relation<
      'api::end-user.end-user',
      'manyToMany',
...
export interface ApiProcessProcess extends Schema.CollectionType {
  ...
  attributes: {
    processName: Attribute.String;
    processUser: Attribute.Relation<
      'api::process.process',
      'manyToMany',
      'api::end-user.end-user'
    >;
    processRole: Attribute.Relation<
      'api::process.process',
      'manyToMany',
      'api::process-role.process-role'
    >;
    processStep: Attribute.Relation<
      'api::process.process',
      'manyToMany',
      'api::process-step.process-step'
    >;
...
export interface ApiProcessRoleProcessRole extends Schema.CollectionType {
...
export interface ApiProcessStepProcessStep extends Schema.CollectionType {
  ...
  attributes: {
    ...
    stepOrder: Attribute.Integer;
    stepUser: Attribute.Relation<
      'api::process-step.process-step',
      'manyToMany',
      'api::end-user.end-user'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::process-role.process-role': ApiProcessRoleProcessRole;
